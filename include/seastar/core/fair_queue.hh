...
private:
    ...
    /*
     * The dF/dt <= K limitation is managed by the token bucket algo where
     * tokens are ticket.normalize(cost_capacity), the refill rate is K.
     *
    ...
    fair_group_atomic_rover _capacity_top;
