...
#include <seastar/util/step_function.hh>
#include <mutex>
#include <array>
...
public:
    ...
    struct config {
        ...
        internal::step_function<unsigned, 3> disk_bytes_write_multiplier = internal::step_function<unsigned, 3>(read_request_base_count);
        internal::step_function<unsigned, 3> disk_bytes_read_multiplier = internal::step_function<unsigned, 3>(read_request_base_count);
        ...
        internal::step_function<unsigned, 2> disk_bytes_mixed_read_multiplier = internal::step_function<unsigned, 2>(read_request_base_count);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        return _fq.waiters() - _pending_cancellations;
