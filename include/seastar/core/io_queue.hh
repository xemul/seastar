...
public:
    ...
    fair_queue_ticket request_fq_ticket_for_queue(internal::io_request::direction dir, size_t len) const noexcept;
...
public:
    ...
    fair_queue_ticket request_fq_ticket(internal::io_request::direction dir, size_t len) const noexcept;
