...
protected:
    ...
    struct outgoing_entry {
        ...
        outgoing_entry(outgoing_entry&& o) noexcept : t(std::move(o.t)), buf(std::move(o.buf)), pcancel(std::exchange(o.pcancel, nullptr)) {
            if (pcancel) {
    ...
    future<> send_entry(std::unique_ptr<std::optional<outgoing_entry>> d);
