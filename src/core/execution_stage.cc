    ...
    , _name(name)
{
    ...
    _metric_group = metrics::metric_group("execution_stages", {
             metrics::make_absolute("tasks_scheduled",
             ...
             metrics::make_absolute("tasks_preempted",
                                  [name, &esm = internal::execution_stage_manager::get()] {
                                  ...
                                  { metrics::label_instance("execution_stage", name), }),
             metrics::make_absolute("function_calls_enqueued",
                                  [name, &esm = internal::execution_stage_manager::get()] {
                                  ...
                                  { metrics::label_instance("execution_stage", name), }),
             metrics::make_absolute("function_calls_executed",
                                  [name, &esm = internal::execution_stage_manager::get()] {
