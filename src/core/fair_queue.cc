...
std::vector<seastar::metrics::impl::metric_definition_impl> fair_queue::metrics(class_id c) {
    ...
    return std::vector<sm::impl::metric_definition_impl>({
            sm::make_derive("pure_tokens",
                    [&pc] { return (double)pc._pure_accumulated / fair_group::fixed_point_factor; },
                    sm::description("Number of accumulated rate-limit tokens")),
            sm::make_derive("real_tokens",
                    [&pc] { return (double)pc._accumulated / fair_group::fixed_point_factor; },
