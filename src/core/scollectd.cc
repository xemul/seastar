...
void impl::start(const sstring & host, const ipv4_addr & addr, const duration period) {
    ...
    _metrics.add_group("scollectd", {
        ...
        sm::make_absolute("total_bytes_sent", _bytes, sm::description("total bytes sent")),
        // total_requests      value:DERIVE:0:U
        sm::make_absolute("total_requests", _num_packets, sm::description("total requests")),
        // latency          value:GAUGE:0:U
        sm::make_gauge("latency", sm::description("avrage latency"), _avg),
        // total_time_in_ms    value:DERIVE:0:U
        sm::make_absolute("total_time_in_ms", _millis, sm::description("total time in milliseconds")),
