...
public:
        ...
        , _xstats(port_idx)
    {
        ...
        _metrics.add_group(_stats_plugin_name, {
            // Rx Good
            sm::make_absolute("rx_multicast", _stats.rx.good.mcast,
                            sm::description("Counts a number of received multicast packets."), {sm::shard_label(_stats_plugin_inst)}),
            // Rx Errors
            sm::make_absolute("rx_crc_errors", _stats.rx.bad.crc,
            ...
            sm::make_absolute("rx_dropped", _stats.rx.bad.dropped,
            ...
            sm::make_absolute("rx_bad_length_errors", _stats.rx.bad.len,
            ...
            // Coupled counters:
            // Good
            sm::make_absolute("rx_pause_xon", _stats.rx.good.pause_xon,
            ...
            sm::make_absolute("tx_pause_xon", _stats.tx.good.pause_xon,
            ...
            sm::make_absolute("rx_pause_xoff", _stats.rx.good.pause_xoff,
            ...
            sm::make_absolute("tx_pause_xoff", _stats.tx.good.pause_xoff,
            ...
            // Errors
            sm::make_absolute("rx_errors", _stats.rx.bad.total,
            ...
            sm::make_absolute("tx_errors", _stats.tx.bad.total,
       ...
       _tx_gc_poller(reactor::poller::simple([&] { return _tx_buf_factory.gc(); }))
{
    ...
    namespace sm = seastar::metrics;
    _metrics.add_group(_stats_plugin_name, {
        sm::make_absolute(_queue_name + "_rx_csum_errors", _stats.rx.bad.csum,
        ...
        sm::make_absolute(_queue_name + "_rx_errors", _stats.rx.bad.total,
                        sm::description("Counts a total number of errors in the ingress path for this queue: CSUM errors, etc.")),

        sm::make_absolute(_queue_name + "_rx_no_memory_errors", _stats.rx.bad.no_mem,
