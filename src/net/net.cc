        ...
        , _queue_name(std::string("queue") + std::to_string(qid))
{
    ...
    _metrics.add_group(_stats_plugin_name, {
        ...
        //
        sm::make_absolute(_queue_name + "_rx_packets", _stats.rx.good.packets,
                        sm::description("This metric is a receive packet rate for this queue.")),

        sm::make_absolute(_queue_name + "_tx_packets", _stats.tx.good.packets,
                        sm::description("This metric is a transmit packet rate for this queue.")),
        //
        // Bytes rate: DERIVE:0:U
        //
        sm::make_absolute(_queue_name + "_rx_bytes", _stats.rx.good.bytes,
                        sm::description("This metric is a receive throughput for this queue.")),

        sm::make_absolute(_queue_name + "_tx_bytes", _stats.tx.good.bytes,
        ...
        //
        sm::make_absolute(_queue_name + "_xmit_linearized", _stats.tx.linearized,
        ...
        //
        // Tx
        sm::make_absolute(_queue_name + "_tx_frags", _stats.tx.good.nr_frags,
        ...
        // Rx
        sm::make_absolute(_queue_name + "_rx_frags", _stats.rx.good.nr_frags,
    ...
    if (register_copy_stats) {
        _metrics.add_group(_stats_plugin_name, {
            ...
            //
            // Tx
            sm::make_absolute(_queue_name + "_tx_copy_bytes", _stats.tx.good.copy_bytes,
            ...
            // Rx
            sm::make_absolute(_queue_name + "_rx_copy_bytes", _stats.rx.good.copy_bytes,
            ...
            //
            // Tx
            sm::make_absolute(_queue_name + "_tx_copy_frags", _stats.tx.good.copy_frags,
            ...
            // Rx
            sm::make_absolute(_queue_name + "_rx_copy_frags", _stats.rx.good.copy_frags,
