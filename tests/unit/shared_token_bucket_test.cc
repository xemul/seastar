...
SEASTAR_TEST_CASE(test_satb_single_class) {
    ...
    satb<>::tokens pouch(tb.burst_limit());
...
SEASTAR_TEST_CASE(test_satb_equal_shares) {
    ...
    satb<>::tokens p1(tb.burst_limit());
    satb<>::tokens p2(tb.burst_limit());
...
SEASTAR_TEST_CASE(test_satb_unequal_shares) {
    ...
    satb<>::tokens p_a(tb.burst_limit());
    satb<>::tokens p_b(tb.burst_limit());
